	...
	public function __construct() {
		parent::__construct($this->id,$this->name,
			...
			array(
				...
				'description'	=> __('Display a video by adding a link or embed code.',$this->domain)
			)
		);
	}
