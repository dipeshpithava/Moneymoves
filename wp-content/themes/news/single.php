                ...
                <div class="main-content <?php if($pagestyle == 'mpls2'){?>left-sidebar<?php }?>">
                    ...
                    <div class="column-two-third single">
                        ...
                        <?php
	                        ...
	                        _e('By:', 'framework');
	                        ?>
	                        <?php the_author_posts_link(); echo $divider; the_category(', '); echo $divider; comments_popup_link(__( 'No Comment', 'framework' ),__( '1 comment', 'framework' ),__( '% Comments', 'framework' ),'',__( 'Comments are off', 'framework' )); ?>  
                       ...
                       <!-- Metabox -->
                        ...
                        <div class="relatednews">
                            <h5 class="line"><span><?php _e('Related Articles', 'framework') ?></span></h5>
                            <span class="liner"></span>
                            <ul>
	                            <?php $related_post_counter = 1; ?>
                            	<?php while($related->have_posts() && $related_post_counter <= 3): $related->the_post(); ?>
								<?php if(has_post_thumbnail()): ?>
                                <li>
                                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(array(640,640)); ?></a>
                                    <p>
