...
<!-- Life Style -->
                    ...
                    <?php
						...
						$cat_name = $admin_data['custom_category_name'];
                        ...
                        <div class="outertight">
                            ...
                            <div class="full-col-12">
										...
										<span class="total_views">
											<i class="fa fa-eye"></i>
												<?php $meta = get_post_meta( get_the_ID(), 'super_post', true ); if(isset($meta['views'])){echo $meta['views']<=1?$meta['views']." View":$meta['views']." Views";}?>
											
										</span>
									</div>
							<span class="meta">
								<?php //if($admin_data['home_date']){ the_time(get_option('date_format'));  }
								if($admin_data['home_category']){if($admin_data['home_date']){echo "";} the_category(', ');} 
								?> 
                            </span>
                            <p><?php the_excerpt(); ?></p>
                        </div>
                        	...
                        	<ul class="block" id="carousel">
                                ...
                                <li>
                                    ...
                                    <div class="full-col-12">
										...
										<span class="total_views">
											<a href="javascript:void(0);" title="<?php $meta = get_post_meta( get_the_ID(), 'super_post', true ); if(isset($meta['views'])){echo $meta['views']<=1?$meta['views']." View":$meta['views']." Views";}?>"><i class="fa fa-eye"></i>
												<?php $meta = get_post_meta( get_the_ID(), 'super_post', true ); if(isset($meta['views'])){echo $meta['views']<=1?$meta['views']." View":$meta['views']." Views";}?>
											</a>
										</span>
									</div>
