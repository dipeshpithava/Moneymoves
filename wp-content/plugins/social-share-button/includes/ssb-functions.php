...
function ssb_share_icons()
	{	
		...
		$ssb_share_icons = '';
		$ssb_share_icons.="<hr style='border-bottom:1px solid #dbdbdb;margin-bottom:20px;' /><div class='ssb-share ssb-share-".get_the_ID()." ".$ssb_share_content_themes."' post_id='".get_the_ID()."' >";
