...
class Forms
{
    ...
    public static function subscriptionForm($fields = array(), $widget = FALSE, $widgetId = '')
    {
        ...
        $form->addText('email', 'Your e-mail address')
            ...
            ->addRule(Form::EMAIL, 'Your e-mail address must be valid.')->setAttribute('class', 'text-email')->setAttribute('placeholder', 'Email ID');
        ...
        // Submit
        $form->addSubmit('submit', 'Submit')->setAttribute('class', 'subscribeButton btn-btn-submit');
